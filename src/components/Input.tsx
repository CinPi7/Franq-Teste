...
const input = tv({
  slots: {
    ...
    control: "placeholder-zinc-100 text-zinc-100",
  },
  ...
  variants: {
    variant: {
      default: {},
      filter: {
        root: "rounded-full py-1.5 px-3 flex items-center gap-1.5 text-xs text-indigo-300 leading-tight border-dashed focus-within:border-zinc-600",
